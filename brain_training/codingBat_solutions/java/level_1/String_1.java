...
/**
 * Created by Kacper Kuźniarski on 12.06.2017.
 */
public class String_1 {
    ...
    public String firstTwo(String str) {
        String a = (str.length() <= 2) ? str : str.substring(0, 2);
        return a;
    }
    ...
    public String twoChar(String str, int index) {
        String a = (((index + 2) <= str.length()) && index > 0) ? str.substring(index, index + 2) : str.substring(0, 2);
        return a;
    }
    ...
    public String lastChars(String a, String b) {
        String result = (a.length() > 0) ? "" + a.charAt(0) : "@";
    ...
    public String conCat(String a, String b) {
        ...
        if (a.length() > 0 && b.length() > 0)
            result = (a.charAt(a.length() - 1) != b.charAt(0)) ? a + b : a + b.substring(1);
        else
            return a + b;
        return result;
    }
    ...
    public String lastTwo(String str) {
        String a = (str.length() >= 2) ? str.substring(0, str.length() - 2)
    ...
    public String minCat(String a, String b) {
        String result = (a.length() >= b.length()) ? a.substring(a.length() - b.length()) + b : a + b.substring(b.length() - a.length());
        return result;
    }
    ...
    public String deFront(String str) {
        String a = "";
        a = ((str.length() > 0) && (str.charAt(0) != 'a')) ? "" : "" + str.charAt(0);
        a += ((str.length() > 1) && (str.charAt(1) != 'b')) ? "" : str.charAt(1);
    ...
    public String startWord(String str, String word) {
        if ((word.length() > 1) && (str.length() > 1) && (word.substring(1).equals(str.substring(1, word.length()))))
